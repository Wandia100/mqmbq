...
/**
 * ArchivedTransactionhistoriesController implements the CRUD actions for TransactionHistories model.
 */
class ArchivedTransactionhistoriesController extends Controller
{
    /**
     * {@inheritdoc}
     */
