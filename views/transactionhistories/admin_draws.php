...
<div class="row">
    <div class="col-md-12"> 
    <?php
    $action='/transactionhistories/admindraws';
                        ...
                        <div class="row">
                            ...
                            <h4><span id="winner_name"><?=(count($show_prizes) > 0?"WAITING FOR DRAW":"NO DRAWS LEFT FOR PRIZE(S)");?></span></h4>
                                ...
                                for($i=0;$i < count($show_prizes); $i++)
                                {
                                    ...
                                    ?>
                                    <button id="<?=$row['prize_id'];?>" class="btn btn-danger" onclick="drawPrize('<?=$station_show_id;?>','<?=$presenter_id;?>','<?=$prize_id;?>','<?=$from;?>',1,'<?=$from;?>')" type="button"><?=$row['name'];?></button>
                                    <?php
                                }
                                ?>
                            </div>
