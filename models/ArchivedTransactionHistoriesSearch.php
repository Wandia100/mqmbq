...
/**
 * ArchivedTransactionHistoriesSearch represents the model behind the search form of `app\models\TransactionHistories`.
 */
class ArchivedTransactionHistoriesSearch extends TransactionHistories
{
    public $stationname;
